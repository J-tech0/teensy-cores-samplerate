...
#define SAMPLE_RATE_PARAM
    ...
    #define AUDIO_TX_SIZE         192                   //usb_desc.h, buffer size dependent on sample rate, 4*45
    #define AUDIO_RX_SIZE         192
    #define USB_AUDIO_FEEDBACK_ACCUMULATOR 805306368    //usb_audio.cpp, feedback_accumulator, 2^24*44.1khz
...
#elif SAMPLE_RATE_PARAM == 96000
    #define AUDIO_SAMPLE_RATE_EXACT 96000.0f            //AudioStream.h, sample rate
    #define AUDIO_TX_SIZE         384                   //usb_desc.h, buffer size dependent on sample rate, 4*45
    #define AUDIO_RX_SIZE         384
    #define USB_AUDIO_FEEDBACK_ACCUMULATOR 1610612736   //usb_audio.cpp, feedback_accumulator, 2^24*44.1khz
    #define USB_AUDIO_SAMPLE_RATE_TARGET 96000          //usb_audio.cpp, USB buffer target
    #define AUDIO_INTERFACE_BUFFER 96000                //usb_audio.cpp, usb.c
    #define USB_DESC_SAMPLERATE 96000                   //usb_desc.c
